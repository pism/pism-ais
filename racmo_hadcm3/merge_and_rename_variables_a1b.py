...
output_file = os.path.join(data_path, dataset+"_input_a1b.nc")

source_file = {"tskin": os.path.join(cf.racmo_hadcm3_data_path,"HadCM3_A1B_I2S_tskin_Y.nc"),
                "smb": os.path.join(cf.racmo_hadcm3_data_path,"HadCM3_A1B_I2S_smb_Y.nc"),
                "Height": os.path.join(cf.racmo_hadcm3_data_path,"Height_latlon_ANT55.nc")}
...
#process_file = {var:os.path.join(data_path, dataset+"_"+var+"_a1b.nc") for var in ["tskin","smb","Height"]}
process_file = {var:os.path.join(data_path, dataset+"_"+var+"_a1b.nc") for var in ["tskin","smb"]}
...
#merge_these_files = " ".join([process_file[var] for var in ["t2m","smb","evap","precip"]])
#merge_these_files = " ".join([process_file[var] for var in ["tskin","smb","Height"]])
...
#subprocess.check_call("ncrename -v Height,usurf -O "+output_file+" "+output_file,shell=True)
