...
inputfile = os.path.join(data_path, 'bheatflx_an_input.nc')
...
#after remap do fill_missing
#ncatted -O -a "_missing_value,bheatflx,o,f,-2e9" bheatflx_an_initmip16km.nc bheatflx_an_initmip16km.nc
#ncatted -O -a "_FillValue,bheatflx,o,f,-2e9" bheatflx_an_initmip16km.nc bheatflx_an_initmip16km.nc

#python /p/projects/tumble/albrecht/pism_input/tools/fill_missing.py -f bheatflx_an_initmip16km.nc -v bheatflx --eps=7.0e-5 -o bheatflx_an_initmip16km_filled.nc
