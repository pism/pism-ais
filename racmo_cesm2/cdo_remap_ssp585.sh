...
#SBATCH --job-name=cdo_remap_ssp585
#SBATCH --account=ice
...
$cdocmd -b F64 -f nc4c remapbil,$griddatadir/$grid.nc $inputdatadir/racmo_cesm2_ssp585.nc $outputdatadir/racmo_cesm2_ssp585_$grid.nc


# add x and y variables to output file.
ncks -A -v x,y $griddatadir/$grid.nc $outputdatadir/racmo_cesm2_ssp585_$grid.nc

echo "regridded file is $outputdatadir/racmo_cesm2_ssp585_$grid.nc"
